...
class MEJEELPController extends Controller
{
    ...
    {
        $teams = MEJEELPTeam::with('translation:name,parent_id,job_title')->get();

        $row = MEJEELP::with('translations')->first();

        return view('admin.MEJEELP_magazine.edit', compact('row', 'teams'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            // 'cbd_id' => 'nullable|integer|exists:m_e_j_e_e_l_p_teams,id',
            // 'ec_id' => 'nullable|integer|exists:m_e_j_e_e_l_p_teams,id',
            // 'dec_id' => 'nullable|integer|exists:m_e_j_e_e_l_p_teams,id',
            // 'me_id' => 'nullable|integer|exists:m_e_j_e_e_l_p_teams,id',

            'team_ids' => "required|array",
            'team_ids.*' => "nullable|exists:m_e_j_e_e_l_p_teams,id",
