...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('afkar-fakar.create') }}">{{ __('global.bodcast.afkar') }}</a></li>
    <li class="breadcrumb-item">{{ __('global.add') }}</li>
@endsection

@section('content')
<form action="{{ route('afkar-fakar.store') }}" method="post">@csrf
    <div class="row">
