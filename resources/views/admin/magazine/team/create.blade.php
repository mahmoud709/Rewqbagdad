...
@section('title', __('global.magazine.team.add'))
...
@section('content')
<form action="{{ url('/admin/magazine-team') }}" method="post">@csrf
    <div class="row">
                            ...
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.magazine.team.name') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.magazine.team.desc') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
