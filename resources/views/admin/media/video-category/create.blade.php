...
@section('title', __('global.media.video.category_add'))
...
@section('content')
<form action="{{ url('/admin/media-videos-categories') }}" method="post">@csrf
    <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        @foreach(SupportedLangs() as $localeCode => $properties)
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.media.video.categor_name') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
