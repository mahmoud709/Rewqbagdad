...
@section('title', __('global.rewaq.team.add'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/admin/rewaq-team') }}">{{ __('global.rewaq.team.title') }}</a></li>
    <li class="breadcrumb-item">@yield('title')</li>
@endsection

@section('content')
<form action="{{ url('/admin/rewaq-team') }}" method="post">@csrf
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <label>{{ __('global.rewaq.team.email') }} <strong class="text-danger">*</strong></label>
            <input type="email" required name="email" value="{{old('email')}}" class="form-control" />
        </div>
        
        <div class="col-md-3 mb-3">
            <label>{{ __('global.rewaq.team.cv_link') }} </label>
        ...
        <div class="col-md-3 mb-3">
            <label>{{ __('global.rewaq.team.img') }} <strong class="text-danger">*</strong></label>
            <div class="input-group">
                <span class="input-group-btn">
        ...
        <div class="col-md-4 mb-3">
            <label>{{ __('global.rewaq.team.job_title') }} <strong class="text-danger">*</strong></label>
            <select name="job_title" required class="form-control">
                @foreach (__('global.rewaq.team.jobs_titles')[appLangKey()] as $key => $job)
                            ...
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.rewaq.team.name') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.rewaq.team.desc') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
