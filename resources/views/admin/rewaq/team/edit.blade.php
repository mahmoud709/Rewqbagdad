...
@section('content')
<form action="{{ url('/admin/rewaq-team/'.$row->id) }}" method="post">@csrf {{ method_field('PUT') }}
    <div class="row">
                            ...
                            <div class="tab-pane {{ ($val->locale==appLangKey())? 'active' : '' }}" id="tab-{{$val->locale}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.rewaq.team.name') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.rewaq.team.desc') }} ({{ LangNative($val->locale) }}) <strong class="text-danger">*</strong></label>
