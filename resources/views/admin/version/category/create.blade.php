...
@section('title', __('global.version.add_category'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('/admin/version-categories') }}">{{ __('global.version.categories') }}</a></li>
    <li class="breadcrumb-item">@yield('title')</li>
@endsection

@section('content')
<form action="{{ url('/admin/version-categories') }}" method="post">@csrf
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group mb-3" dir="ltr">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">{{url('versions/category')}}/</span>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        @foreach(SupportedLangs() as $localeCode => $properties)
                            <div class="tab-pane {{ ($localeCode==appLangKey())? 'active' : '' }}" id="tab-{{$localeCode}}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>{{ __('global.version.categor_name') }} ({{ $properties['native'] }}) <strong class="text-danger">*</strong></label>
