...
@section('content')
    ...
    <section class="contact-page-section asking asking-visit">
        <div class="container p-5">
            <form class="row" action="{{ route('mejeelp.mail.bookingBook') }}" method="post">
                @csrf
                        ...
                        <div class="contact-form">
                            ...
                            <div id="contact-form" novalidate="novalidate">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <label for="name"> <span class="req">*</span> {{ __('front.name_number') }}</label>
                                        <input type="text" name="name_number" required value="{{ old('name_number',$blog->translation->title ) }}"
                                            placeholder="{{ __('front.name_number') }}">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
