...
@section('title', __('front.contact_us').' - '.__('front.MEJEELP_magazine'))
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-brown"><a href="{{ langUrl('/MEJEELP-magazine') }}">{{__('front.MEJEELP_magazine')}}</a></li>
