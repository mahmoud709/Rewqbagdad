...
@section('content')
    ...
    <section class="contact-page-section asking asking-visit">
        <div class="container p-5">
            <form class="row" action="{{ route('magazine.rewaq.mail.bookingBook') }}" method="post">
                @csrf
                            ...
                            <div id="contact-form" novalidate="novalidate">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="text" name="name_version" required value="{{ old('name_version',$blog->translation->title ) }}"
